...
class JwtTokenMockerTest {
    ...
    public void testGenerateTokenValidForSeconds() throws ParseException {
        ...
        // previous implementation didn't work correctly timezones different from UTC
        // which caused that expiration time from generated token was moved several hours ahead or behind actual time
